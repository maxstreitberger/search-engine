...
TEST_CASE("Can remove white space infront of a text.", "[helpers]") {
...
TEST_CASE("Can remove white space behind a text.", "[helpers]") {
    std::string text = "hello  ";
    std::string expectedText = "hello";
    helpers::rtrim(text);
    REQUIRE( text == expectedText );
...
TEST_CASE("Can remove white space around a text.", "[helpers]") {
    std::string text = "  hello  ";
    std::string expectedText = "hello";
    helpers::trim(text);
    REQUIRE( text == expectedText );
...
TEST_CASE("Can make a text to lowercase.", "[helpers]") {
    std::string text = "HELLO";
    std::string expectedText = "hello";
...
TEST_CASE("Can load text.", "[helpers]") {
