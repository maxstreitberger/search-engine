...
TEST_CASE("Indexer end-to-end test.", "[indexer, e2e]") {
    ...
    std::vector<docmeta::DocumentMeta> repository = {
        docmeta::DocumentMeta(1, "Hello, World! How are you world?", "DOCUMENT PATH"),
        docmeta::DocumentMeta(2, "Quisque gravida erat at turpis sodales euismod ut vitae justo.", "DOCUMENT PATH"),
    };
