...
TEST_CASE("Ranker returns correct documents", "[ranker]") {
    std::set<docmeta::DocumentMeta> store = { 
        docmeta::DocumentMeta(1, "Lorem ipsum dolor sit amet, consectetur sit elit. Vestibulum bibendum.", RANKING_TESTING_ROOT_DIR "/testing-documents/demo.txt"),
        docmeta::DocumentMeta(2, "Ut bibendum leo ac neque vehicula fermentum. Amet vitae lorem.", RANKING_TESTING_ROOT_DIR "/testing-documents/demo2.txt"),
        docmeta::DocumentMeta(3, "Vestibulum accumsan dolor elit sit iaculis leo. Praesent et elit.", RANKING_TESTING_ROOT_DIR "/testing-documents/demo3.txt")
    };
